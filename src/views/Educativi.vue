  ...
  <div class="container-d-flex">
    <div class="row fs-6 mb-4">
      <div class="col-11">
        ...
        <ul>
          <li>
            “Games&Bones” nasce dall’esigenza di trovare nuovi strumenti didattici, individuati
            nelle tipologie di giochi, per divulgare l’osteologia e le discipline afferenti (storia,
            archeologia, matematica, fisica, chimica, geologia, informatica,…)
          </li>
        </ul>
    ...
    <div class="row fs-6 mb-4">
      <div class="col-11">
        ...
        <ul>
          <li>
            Corsi e laboratori per i soci (Laboratorio di microscopia; Laboratorio cremazioni,
            Laboratorio di Odontologia, Apprendisti Osteologi, Archeoscienziati, etc.)
          </li>
        </ul>
      </div>
    </div>
